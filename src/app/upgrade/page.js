...
const App = () => {
// Drives the one-time staggered entrance for the header + CTA row on load
const [mounted, setMounted] = useState(false);

// Drives the one-time reveal on the "Core Values" banner when it scrolls into view
...
return ( <div className="min-h-screen bg-gradient-to-b from-emerald-50/50 via-white to-white p-2"> <Navbar />
    ...
    <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
      ...
      <div>
        <Badge className="mb-4 bg-emerald-100 text-emerald-800 hover:bg-emerald-100 border-0">
          ...
          Verified freelance care, on demand
        </Badge>
        ...
        <p className="mt-6 max-w-xl text-lg text-slate-600">
          Karema Kare Hub helps independent healthcare workers - submit
          credentials, set their own daily rates, and land trusted freelance
          shifts.
        </p>
      ...
      <div className="relative">
        <div className="absolute -inset-4 bg-gradient-to-br from-emerald-200 to-teal-200 rounded-3xl blur-2xl opacity-40" />
          ...
          <CardContent className="p-8">
            ...
            <div className="space-y-3">
              {[
                {
                  icon: Stethoscope,
                  label: 'Registered Nurse • 8 years',
                  value: '$580/day',
                },
                {
                  icon: FileCheck2,
  ...
  <section className="py-24 px-4 relative overflow-hidden">
    ...
    <div
      aria-hidden="true"
      className="pointer-events-none absolute -top-24 right-[-8%] h-[420px] w-[420px] rounded-full bg-gradient-to-br from-emerald-200/40 to-teal-200/30 blur-3xl motion-safe:animate-drift"
    />
    ...
    <div className="max-w-7xl mx-auto relative">
      ...
      {/* CTA Buttons */}
      <div
        className={`mt-8 mb-20 flex flex-wrap gap-3 transition-all duration-700 ease-out delay-150 ${
          mounted
            ? 'opacity-100 translate-y-0'
            : 'opacity-0 translate-y-4'
        }`}
      >
        <Link href="/apply">
          <Button
            size="lg"
            className="bg-emerald-600 hover:bg-emerald-700 shadow-lg shadow-emerald-600/20 transition-transform duration-200 hover:-translate-y-0.5 active:translate-y-0"
          >
            Start your application
          </Button>
        </Link>
      ...
      <div className="grid md:grid-cols-3 gap-6">
        ...
        {/* Professionals */}
        <Card className="group relative overflow-hidden border-emerald-100 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-emerald-100/50">
          <CardContent className="p-8">

            <div className="w-14 h-14 rounded-2xl bg-emerald-100 flex items-center justify-center mb-6 transition-transform duration-300 group-hover:scale-110 group-hover:rotate-3">
        ...
        {/* Families */}
        <Card className="group relative overflow-hidden border-teal-100 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-teal-100/50">
          <CardContent className="p-8">

            <div className="w-14 h-14 rounded-2xl bg-teal-100 flex items-center justify-center mb-6 transition-transform duration-300 group-hover:scale-110 group-hover:rotate-3">
            ...
            <p className="mt-3 text-slate-600 leading-relaxed">
              Find trusted professionals for your loved ones who matter
              most, who can provide the care and support you need.
            </p>
        ...
        {/* Businesses */}
        <Card className="group relative overflow-hidden border-cyan-100 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-cyan-100/50">
          <CardContent className="p-8">

            <div className="w-14 h-14 rounded-2xl bg-cyan-100 flex items-center justify-center mb-6 transition-transform duration-300 group-hover:scale-110 group-hover:rotate-3">
            ...
            <p className="mt-3 text-slate-600 leading-relaxed">
              Find the professionals you need, when you need them. Connect
              with vetted professionals and access services that support
      ...
      <div
        ref={bannerRef}
        className={`mt-12 rounded-3xl bg-gradient-to-r from-emerald-600 to-teal-700 p-2 md:p-10 text-white text-center shadow-xl shadow-emerald-600/20 transition-all duration-700 ease-out ${
          bannerInView
      ...
      <div className="mt-20">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          ...
          {/* Future products can be enabled here */}
  ...
  <section className="pb-24 mx-4">
    ...
    <div className="text-center mb-12">
      ...
      <p className="mt-2 text-slate-600">
        Three steps to start earning as a freelance healthcare pro.
      </p>
    </div>
      ...
      {[
        {
          ...
          desc: 'Sign up with email and password. Takes less than a minute.',
          icon: HeartPulse,
        },
        {
          n: '02',
          title: 'Submit credentials',
          desc: 'Upload ID, license, certifications and set your daily rate.',
          icon: FileCheck2,
        },
        {
          n: '03',
          title: 'Get verified & hired',
          desc: 'Our team reviews your profile and unlocks shift opportunities.',
          icon: ShieldCheck,
        },
      ].map((s) => (
        <Card
          key={s.n}
          className="group border-emerald-100 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-emerald-100"
        >
          <CardContent className="p-6">

            <div className="flex items-center gap-3 mb-4">

              <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-emerald-100 text-emerald-700 transition-transform duration-300 group-hover:scale-110 group-hover:-rotate-6">
    ...
    <div className="flex items-center justify-between mb-10">
      <div>
        ...
        <p className="text-slate-600 mt-2">
          Stay informed with healthcare news, platform updates and
          training videos.
        </p>
      </div>
  ...
  <footer className="border-t border-slate-100 py-8">
    <div className="container text-center text-sm text-slate-500">
      &copy; {new Date().getFullYear()} Karema Kare Hub.
      Built for verified freelance care.
    </div>
  </footer>
  */}
